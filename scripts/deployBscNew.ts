...
async function deploy() {
  try {
    ...
    const tx5 = await swapHandlerContract.init(
      inputData.pancakeSwapRouterAddress,
      "0x70378D151D6203219D5bED3A855026f67815E052",
    );
    tx5.wait(2);
    // ------------------------------------------------------------------------------------------------------------------------ //
    //Deploy Handlers
    ...
    const tx = await zeroExHandler
      .attach(zeroExHandler.address)
      .init("0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c", "0xdef1c0ded9bec7f1a1670819833240f027b25eff");
    tx.wait(2);
    ...
    const tx2 = await oneInchHandler
      .attach(oneInchHandler.address)
      .init("0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c", "0x1111111254EEB25477B68fb85Ed929f73A960582");
    tx2.wait(2);
    ...
    const tx4 = await tokenRegistryContract.enablePermittedTokens([
...
async function initializeTokenRegistry(_tokenRegistry: string, _priceOracle: string) {
  ...
  const tx = await tokenRegistryContract.enableToken(
    priceOracleArray,
    addressArray,
    handlerArray,
    rewardArray,
